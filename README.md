...
Quanto tempo de trabalho custa a riqueza dos mais ricos do Brasil? [umpixel.com.br](https://umpixel.com.br)
responde com uma régua simples: **1 pixel = 1 mês do seu salário**. Doze pixels são um ano,
564 pixels são uma vida inteira de trabalho. A partir daí, as maiores fortunas do país viram
colunas gigantes que você desce por minutos, sentindo no scroll o tamanho da desigualdade. Tudo
em pt-BR, em escala real, com os números ajustáveis pelo seu próprio salário.
...
site, um script de ingestão só precisa sobrescrever os arquivos em `public/data/` — o HTML não
...
| Pessoa mais rica             | Eduardo Saverin, US$ 35,9 bi  | Forbes World's Billionaires 2026   | mar/2026      |
...
O arquivo `public/data/README.md` explica cada JSON e como atualizá-lo. O `renda-brasil.json`
hoje só alimenta a lista de fontes; fica reservado para uma fase futura de fatos intermediários.
